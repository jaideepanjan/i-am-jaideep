...
public class BeanRunner {
	...
	public static void main(String[] args) {
		...
		Actor refOfActor1 = container.getBean("Actorr",Actor.class);
		...
		Rocket refOfRocket1=container.getBean("Rockett",Rocket.class);
		...
		Season refOfSeason = container.getBean("Rutu",Season.class);
		...
		Season refOfSeason1 = container.getBean("Rutu",Season.class);
